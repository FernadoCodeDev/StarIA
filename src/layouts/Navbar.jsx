...
const NawBar = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="flex-col hidden w-20 h-full gap-4 border-r-2 bg-slate-100 md:flex align-center border-zinc-950 dark:border-slate-100 dark:bg-zinc-950 ">
        <img
          src="/img/Logo.webp"
          alt="Logo"
      ...
      <div
        className={`fixed  top-0 left-0 w-full text-zinc-950 dark:text-slate-100  md:max-w-40 h-full bg-slate-200 dark:bg-zinc-900  transition-transform duration-700 ease-in-out transform z-50 ${menuOpen ? "translate-x-0" : "-translate-x-full"
          }`}
      >
        <div className="flex flex-row justify-between p-4">
          ...
          <button
            onClick={toggleMenu}
            className="p-2 rounded-md text-slate-100 dark:text-zinc-950 dark:bg-slate-100 bg-neutral-800 h-1/2"
          >
