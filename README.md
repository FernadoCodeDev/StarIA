> [!IMPORTANT]  
> El modelo de **GROQ** con el modelo de OpenAI **puede cometer errores, Siempre se recomienda verificar información importante**
...
Decidí construir **StarIA** con el siguiente stack:
